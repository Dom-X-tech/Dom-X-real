...
// ========== SESSION SCHEMA (PERSISTENT) ==========
const SessionSchema = new mongoose.Schema({
    userId: { type: String, unique: true, required: true },
    phoneNumber: { type: String, default: '' },
    creds: { type: Object, default: null },  // Stores creds.json data
    sessionId: { type: String, default: '' }, // One-line session string
...
╚══════════════════════════════════╝
            ...
            // === COMMAND 4: STICKER ===
                ...
                const quoted = EliteProTech.ev?.messages?.upsert?.[0]?.message?.extendedTextMessage?.contextInfo?.quotedMessage;
